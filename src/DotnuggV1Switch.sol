...
import "git.nugg.xyz/dotnugg/src/abi/Decode.sol" as decode;

import {cds} from "git.nugg.xyz/dotnugg/src/abi/Pointer.sol";
...
contract DotnuggV1Raw is DotnuggV1Base {
	...
	{
		uint256[][] memory reads =
			decode.to_dyn_array_dyn_array_uint256_ReturnType(decode.abi_decode_dyn_array_dyn_array_uint256)(cds.pptr());
	...
	function __svg()
		/**
		 * uint256[] calldata, uint256 dat, bool base64
		 */
		internal
	/**
	 ...
	 */
	{
		...
		uint256[] memory calculated =
			decode.to_dyn_array_uint256_ReturnType(decode.abi_decode_dyn_array_uint256)(cds.pptr());
	...
	function __exec3()
		/**
		 * uint8 feature, uint8 pos, bool base64
		 */
		internal
	/**
	 * returns (string memory)
	...
	// prettier-ignore
	function __encodeSvg()
		/**
		 * bytes calldata, bool base64
		 */
		internal
	/**
...
contract DotnuggV1Switch is DotnuggV1Raw {
	constructor() {
